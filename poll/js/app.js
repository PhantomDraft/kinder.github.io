...
function genAdvanced() {
  ...
  t.push({
    text: `Заполни пропуск: _\u200b_\u200b_, ${Q}, ${Q + 1}. Какое число находится непосредственно перед ${Q}?\n___`,
    dataAnswer: `${Q - 1}`
  });
  ...
  t.push({
    text: `В последовательности: ${S}, _\u200b_\u200b_, ${S + 2} – какое число должно стоять между ${S} и ${S + 2}?\n___`,
    dataAnswer: `${S + 1}`
  });
  ...
  t.push({
    text: `Заполни пропуски: ${G1}, _\u200b_\u200b_, ${G1 + 2 * H1}, _\u200b_\u200b_, ${G1 + 4 * H1}, если каждое число увеличивается на ${H1}.\n___, ___`,
  ...
  t.push({
    text: `Запоминай: Доводим до 10: ___\nДалее: ___`,
